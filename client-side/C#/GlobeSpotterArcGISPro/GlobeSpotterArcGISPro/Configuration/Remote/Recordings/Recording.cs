...
namespace GlobeSpotterArcGISPro.Configuration.Remote.Recordings
{
  ...
  public class Recording
  {
    ...
    private const string FieldId = "Id";                            // "Id"
    private const string FieldImageId = "ImageId";                  // "ImageId"
    private const string FieldRecordedAt = "RecordedAt";            // "RecordedAt"
    private const string FieldLatitudePrecision = "LatPrec";        // "LatitudePrecision"
    private const string FieldLongitudePrecision = "LongPrec";      // "LongitudePrecision"
    private const string FieldHeightPrecision = "HeightPrec";       // "HeightPrecision"
    private const string FieldOrientation = "Orient";               // "Orientation"
    private const string FieldOrientationPrecision = "OrientPrec";  // "OrientationPrecision"
    private const string FieldGroundLevelOffset = "GroundLev";      // "GroundLevelOffset"
    private const string FieldRecorderDirection = "RecordDir";      // "RecorderDirection"
    private const string FieldProductType = "ProdType";             // "ProductType"
    private const string FieldIsAuthorized = "IsAuthoriz";          // "IsAuthorized"
    private const string FieldExpiredAt = "ExpiredAt";              // "ExpiredAt"
    private const string FieldTileSchema = "TileSchema";            // "TileSchema"
    private const string FieldYear = "Year";                        // "Year"
    private const string FieldPip = "PIP";                          // "PIP"
    private const string FieldPip1Yaw = "PIP1Yaw";                  // "PIP1Yaw"
    private const string FieldPip2Yaw = "PIP2Yaw";                  // "PIP2Yaw"
    private const string FieldShape = "Shape";                      // "Shape"
